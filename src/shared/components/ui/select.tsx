...
>(({ className, children, ...props }, ref) => (
	<SelectPrimitive.Trigger
		ref={ref}
		className={cn(
			'flex h-12 w-full items-center justify-between rounded-md border border-transparent focus:border-primary bg-gray px-3 py-2 text-sm text-black  text-opacity-40 placeholder:text-neutral-500 focus:outline-none',
			className
		)}
		{...props}
	>
